 ...
 * Get All Templates
 */
export const getAllTemplatesApiV1MenuTemplatesGet = <ThrowOnError extends boolean = false>(options?: Options<GetAllTemplatesApiV1MenuTemplatesGetData, ThrowOnError>): RequestResult<GetAllTemplatesApiV1MenuTemplatesGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetAllTemplatesApiV1MenuTemplatesGetResponses, unknown, ThrowOnError>({
    responseType: 'json',
 ...
 * Get Template By Id
 */
export const getTemplateByIdApiV1MenuTemplatesTemplateIdGet = <ThrowOnError extends boolean = false>(options: Options<GetTemplateByIdApiV1MenuTemplatesTemplateIdGetData, ThrowOnError>): RequestResult<GetTemplateByIdApiV1MenuTemplatesTemplateIdGetResponses, GetTemplateByIdApiV1MenuTemplatesTemplateIdGetErrors, ThrowOnError> => (options.client ?? client).get<GetTemplateByIdApiV1MenuTemplatesTemplateIdGetResponses, GetTemplateByIdApiV1MenuTemplatesTemplateIdGetErrors, ThrowOnError>({
    responseType: 'json',
